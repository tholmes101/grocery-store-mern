...
const Navbar = () => {
     ...
     getCartCount, axios}  // axios added after bss
      = useAppContext()

     const logout = async () => {
        try {                 // try/catch added after backend server setup
          const {data} = await axios.get('/api/user/logout') // API call
          if (data.success) {
  ...
  return (
    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 
                    py-4 border-b border-gray-200 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={()=> navigate("/cart")} className="relative cursor-pointer">
                    ...
                    <svg 
                      ...
                      xmlns="http://www.w3.org/2000/svg"> <path d="M.583.583h2.333l1.564 
                      7.81a1.17 1.17 0 0 0 1.166.94h5.67a1.17 1.17 0 0 0 
                      1.167-.94l.933-4.893H3.5m2.333 8.75a.583.583 0 1 
                      1-1.167 0 .583.583 0 0 1 1.167 0m6.417 0a.583.583 0 1 1-1.167 0 
                      .583.583 0 0 1 1.167 0" stroke="#010013ff" stroke-linecap="round"
                ...
                (
                  <div className='relative group'>
                    <img src={assets.profile_user} className='w-10' alt="" />
                    ...
                    border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                        <li onClick={()=> navigate("my-orders")} className='p-1.5 pl-3 hover:bg-primary/10 
                        cursor-pointer'>My Orders</li>
          ...
          { open && (
            <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
                ...
                <NavLink to="/procucts" onClick={()=> setOpen(false)}>All Product</NavLink>
                {user &&
